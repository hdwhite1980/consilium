...
#
# Desktop (xl+): [Today] [Tomorrow] [Invest] [Discover ▾] [Positions ▾]
#                [Compare] [Track Record] [Guide]
#
#   Discover ▾ : Screener, Scanner, Options, Macro, Altcoins
#   Positions ▾: Portfolio, Watchlist
#
...
Write-Host "  [Today] [Tomorrow] [Invest] [Discover ▾] [Positions ▾] [Compare] [Track Record] [Guide]"
Write-Host ""
...
Write-Host "  - ChevronDown rotates 180° when open"
