      ...
      <div className="space-y-3">
        {stages.map((s, i) => (
          <div key={s.name} className="flex items-center gap-3">
            ...
            {i < stages.length - 1 && (
              <div style={{ color: 'var(--text3)', fontSize: '12px' }}>↓</div>
            )}
          </div>
        ))}
      </div>
    ...
    <div className="grid md:grid-cols-3" style={{ minHeight: '480px' }}>
      ...
      >
        ...
        <div style={{ color: 'var(--text2)', fontSize: '13px', marginBottom: '24px' }}>
          73% confidence · 3-10 day timeframe
        </div>

        <Field label="Entry"           value="$180-182" />
        <Field label="Stop"            value="$171 (2× ATR)" />
      ...
      <div className="md:col-span-2" style={{ padding: '24px' }}>
        ...
        <Voice
          who="Lead — Round 2"
          color="#a78bfa"
          line="Asked News Scout for the historical earnings move data. Implied move is 4.8%; historical actual is 3.6%. Options are slightly overpriced. Conceding partial point — if the print misses, the stop triggers cleanly. Position size accordingly."
        />
        <Voice
          who="Devil — Round 2"
          color="#34d399"
        ...
        <Voice
          who="Judge"
          color="#fbbf24"
          line="Lead's technical case is well-cited and survived cross-examination. Devil's earnings concern is legitimate but bounded by the stop. Verdict: BULLISH at 73% — cap position size at 60% of normal given earnings within the window."
        />
      </div>
    </div>
  )
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          guarantee future results. Trading carries risk of loss. © {new Date().getFullYear()} Wali-OS.
        </div>
      </div>
    </footer>
  )
