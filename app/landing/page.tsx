...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Pipeline diagram â€” illustrates the six-stage Council flow
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function PipelineDiagram() {
  const stages = [
    ...
    { name: 'Round 2 â€” Research', role: 'Both sides probe', color: '#60a5fa' },
    { name: 'Round 2 â€” Rebuttal', role: 'Defend or concede', color: '#a78bfa' },
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-5" style={{ color: 'var(--text3)', fontSize: '12px', letterSpacing: '0.06em' }}>
        ...
        COUNCIL PIPELINE â€” RUNNING ANALYSIS
      </div>
      <div className="space-y-3">
        {stages.map((s, i) => (
          <div key={s.name} className="flex items-center gap-3">
            ...
            {i < stages.length - 1 && (
              <div style={{ color: 'var(--text3)', fontSize: '12px' }}>â†“</div>
            )}
          </div>
        ))}
      </div>
      ...
      >
        VERDICT: BULLISH @ 73% confidence Â· stop $171 Â· target $236 Â· 3-10d
      </div>
    </div>
  )
}
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <PillarCard
            ...
            body="Every BULLISH and BEARISH verdict is logged with a timestamp and price. An automated job computes the actual outcome at one week and one month â€” strict and directional. Hit rates by lens, timeframe, and confidence band are public."
    ...
    <section id="sample" className="max-w-6xl mx-auto px-6 py-20">
      <div className="text-center mb-12">
        ...
        <p style={{ color: 'var(--text2)', maxWidth: '600px', margin: '12px auto 0', fontSize: '15px' }}>
          ...
          stop, the target, the invalidation trigger â€” all visible.
        </p>
      </div>

      {/* TODO: Replace this placeholder with a real screenshot of an analysis.
          Recommended image: a screenshot of the verdict page for a recent ticker
          (e.g. NVDA, AAPL, or BTC) showing the transcript section, the verdict
          header, and the smart money section. See MIGRATION_NOTES.md for specs. */}
      <div
        className="t-card"
        style={{
          background: 'var(--surface)',
      ...
      <div className="text-center mt-8">
        <Link
          ...
          className="hover:opacity-80 transition"
        >
          Run your own analysis â€” start free trial â†’
        </Link>
      </div>
    </section>
  )
...
function SampleTranscript() {
  return (
    <div className="grid md:grid-cols-3" style={{ minHeight: '480px' }}>
      ...
      >
        <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '11px', color: 'var(--text3)', letterSpacing: '0.08em', marginBottom: '12px' }}>
          VERDICT
        </div>
        <div style={{ fontSize: '32px', fontWeight: 600, color: '#34d399', marginBottom: '4px' }}>
          BULLISH
        </div>
        <div style={{ color: 'var(--text2)', fontSize: '13px', marginBottom: '24px' }}>
          73% confidence Â· 3-10 day timeframe
        </div>

        <Field label="Entry"           value="$180-182" />
        <Field label="Stop"            value="$171 (2Ã— ATR)" />
        <Field label="First take-profit" value="$236" />
        <Field label="Invalidation"    value="Close below $171" />

        <div style={{ marginTop: '24px', paddingTop: '20px', borderTop: '1px solid var(--border)' }}>
          <div style={{ color: 'var(--text3)', fontSize: '11px', letterSpacing: '0.06em', marginBottom: '8px' }}>
            SMART MONEY
          </div>
          <div style={{ fontSize: '13px', color: 'var(--text2)', lineHeight: 1.5 }}>
            CFO bought 5,000 shares @ $178.20 ($891K). Two new institutional positions in the latest 13-F.
          </div>
        </div>
      </div>

      {/* Right: transcript */}
      <div className="md:col-span-2" style={{ padding: '24px' }}>
        <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '11px', color: 'var(--text3)', letterSpacing: '0.08em', marginBottom: '16px' }}>
          TRANSCRIPT â€” TECHNICAL LENS
        </div>

        <Voice
          who="Lead Analyst"
          color="#a78bfa"
          line="Setup is clean. Higher highs / higher lows on the daily, golden cross 18 sessions ago, RSI 58 with room to run, ATR-derived stop sits below the 50-day. Relative strength versus the sector is +6.4%."
        />
        <Voice
          who="Devil's Advocate"
          color="#34d399"
          line="The chart looks fine, but you're ignoring that the forward P/E is 31 against a 5-year median of 24. Earnings are in 11 days. The setup is valid only if the print is clean."
        />
        <Voice
          who="Lead â€” Round 2"
          color="#a78bfa"
          line="Asked News Scout for the historical earnings move data. Implied move is 4.8%; historical actual is 3.6%. Options are slightly overpriced. Conceding partial point â€” if the print misses, the stop triggers cleanly. Position size accordingly."
        />
        <Voice
          who="Devil â€” Round 2"
          color="#34d399"
          line="Conceding partial point on the position. The stop is well-defined. Risk is bounded."
        />
        <Voice
          who="Judge"
          color="#fbbf24"
          line="Lead's technical case is well-cited and survived cross-examination. Devil's earnings concern is legitimate but bounded by the stop. Verdict: BULLISH at 73% â€” cap position size at 60% of normal given earnings within the window."
        />
      </div>
    </div>
  )
...
function Field({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ marginBottom: '12px' }}>
      <div style={{ color: 'var(--text3)', fontSize: '11px', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
        {label}
      </div>
      <div style={{ color: 'var(--text)', fontSize: '14px', fontWeight: 500, fontFamily: 'IBM Plex Mono, monospace' }}>
        {value}
      </div>
    </div>
  )
...
function Voice({ who, color, line }: { who: string; color: string; line: string }) {
  return (
    <div style={{ marginBottom: '20px' }}>
      <div style={{ color, fontSize: '12px', fontWeight: 600, marginBottom: '4px', fontFamily: 'IBM Plex Mono, monospace', letterSpacing: '0.02em' }}>
        {who}
      </div>
...
function FeatureGrid() {
  const features = [
    { icon: <Briefcase size={18} />,    title: 'Portfolio analysis',       body: 'Add real holdings â€” get sector concentration, theta decay, earnings timing risk, and a 3-step action plan.' },
    ...
    { icon: <Users size={18} />,         title: 'Head-to-head comparison',  body: 'Run the Council on two tickers simultaneously â€” get a definitive "if you can only pick one" verdict.' },
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <PricingCard
            ...
            features={[
              ...
              'Tradier production options chain â€” real Greeks',
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          guarantee future results. Trading carries risk of loss. Â© {new Date().getFullYear()} Wali-OS.
        </div>
      </div>
    </footer>
  )
