      ...
      try {
        ...
        send('market_data', {
          ...
          technicals: {
            ...
            ema9: bundle.technicals.ema9,
            ema20: bundle.technicals.ema20,
            support: bundle.technicals.support,
            support2: bundle.technicals.support2,
            resistance: bundle.technicals.resistance,
            resistance2: bundle.technicals.resistance2,
            goldenCross: bundle.technicals.goldenCross,
            ema9CrossEma20: bundle.technicals.ema9CrossEma20,
            macdLine: bundle.technicals.macdLine,
            macdSignal: bundle.technicals.macdSignal,
            macdHistogram: bundle.technicals.macdHistogram,
            macdCrossover: bundle.technicals.macdCrossover,
            bbPosition: bundle.technicals.bbPosition,
            bbSignal: bundle.technicals.bbSignal,
            bbUpper: bundle.technicals.bbUpper,
            bbMiddle: bundle.technicals.bbMiddle,
            bbLower: bundle.technicals.bbLower,
            stochK: bundle.technicals.stochK,
            stochD: bundle.technicals.stochD,
            stochSignal: bundle.technicals.stochSignal,
            stochCrossover: bundle.technicals.stochCrossover,
            vwap: bundle.technicals.vwap,
            priceVsVwap: bundle.technicals.priceVsVwap,
            vwapSignal: bundle.technicals.vwapSignal,
            obv: bundle.technicals.obv,
            obvTrend: bundle.technicals.obvTrend,
            obvDivergence: bundle.technicals.obvDivergence,
            volumeRatio: bundle.technicals.volumeRatio,
            priceChange1D: bundle.technicals.priceChange1D,
            fibLevels: bundle.technicals.fibLevels,
            nearestFibLevel: bundle.technicals.nearestFibLevel,
          },
          conviction: {
